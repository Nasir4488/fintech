...
class Totalincome extends StatefulWidget {
  ...
  Totalincome({super.key, required this.transactions});
...
class _TotalincomeState extends State<Totalincome>
  ...
  final List<String> allowedCategories = ["Salary", "Freelance", "Business", "Investment"];
      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              "No income transactions for the selected period",
              style: TextStyle(
