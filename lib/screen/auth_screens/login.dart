  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: Appbar_wegit(arrow: true,title: "Login",)
      ),
      body: ListView(
        children: [
          Container(
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("Login to continue ",style: Theme.of(context).textTheme.bodySmall!.copyWith(color: blackTextColor,fontWeight: FontWeight.bold),),
                        ],
                      ),
                    ),
                    SizedBox(height: 10,),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Forget Password",style: Theme.of(context).textTheme.bodySmall!.copyWith(color: primaryTextColor),),
                          SizedBox(width: 16),
                        ],
                      ),
                    ),
                    Row(
                      ...
                      children: [
                        Text("Don't have already account",style: Theme.of(context).textTheme.bodySmall,),
                        SizedBox(width: 8),
                        TextButton(
                            onPressed: (){
                              Get.toNamed(AllRoutes.homePage);
                            },
                            child: Text("SignUp",style: Theme.of(context).textTheme.bodySmall!.copyWith(color: primaryTextColor),)
                        ),
                      ],
                    )
                  ],
