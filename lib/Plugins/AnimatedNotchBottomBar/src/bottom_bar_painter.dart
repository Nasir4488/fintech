...
class BottomBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    _paint.shader = linearGradient.createShader(Rect.fromLTWH(-2,1, size.width, size.height));
  ...
  void _drawFloatingCircle(Canvas canvas) {
    _notchPaint.shader = linearGradient.createShader(Rect.fromCircle(center: Offset(position, kMargin), radius: kCircleRadius));
